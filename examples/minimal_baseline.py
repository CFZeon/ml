"""Minimal baseline example via the shared config-driven runner."""
...
def main():
    args = parse_example_args("Run the minimal baseline example.")
    run_example(
        ...
        example_name="examples/minimal_baseline.py",
    )
