...
2. [x] Eliminate Global Stationarity "Preview": Implement strict fold-local ADF testing and transform selection to ensure zero leakage.
...
4. [x] Integrate KPSS test: Add to stationarity screening as a counter-balance to ADF to prevent over-differencing and signal destruction.
