"""Trend, volume, and breakout spot example via the shared runner."""
...
def main():
    args = parse_example_args("Run the trend-volume spot example.")
    run_example(
        resolve_repo_path("configs", "btc_trend_volume_spot.yaml"),
        market="spot",
